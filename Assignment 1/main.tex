...
\begin{lstlisting}
https://github.com/Digjoy12/Signal-Processing/blob/main/Assignment%201/Code/untitled1.py
\end{lstlisting}
%
and latex codes from 
%
\begin{lstlisting}
https://github.com/Digjoy12/Signal-Processing/blob/main/Assignment%201/main.tex
\end{lstlisting}
...
-5 & -2\\
 5 & 2
\end{pmatrix} \xleftrightarrow{\text{$R_1$}\rightarrow{\text{$-R_1$}}} 
 \begin{pmatrix}
 5 & 2 \\
 5 & 2
